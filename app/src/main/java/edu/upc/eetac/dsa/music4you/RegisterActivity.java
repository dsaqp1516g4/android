...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void attemptRegister(){
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserRegisterTask(username,password, email,name );
    ...
    public class UserRegisterTask extends AsyncTask<Void, Void, user> {
        ...
        UserRegisterTask(String username, String password, String email, String name ) {
            mUsername = username;
            mEmail = email;
            mPassword = password;
            mName = name;
        ...
        protected user doInBackground(Void... params) {
            ...
            user = client.register(mUsername, mPassword, mEmail, mName );
            return user;
        }
